            ...
            <div class="box-body">
                ...
                <div class="panel-heading" style="background-color: white;">
                    <h3 class="panel-title" style="text-align: center">
                            ...
                            <img src="img/logos/dominio_<?php echo $_REQUEST['dominio']; ?>.jpg"/>
                ...
                <div class="panel-body">
                    ...
                    <fieldset>
                        ...
                        <div id="div_dni" class="ui-widget">
                            ...
                            <input class="form-control" name="dominio" id="dominio" type="hidden" value="<?php echo $_REQUEST['dominio']; ?>" >
                        </div>

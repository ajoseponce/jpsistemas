<div class="modal" id="nueva_garante" style="z-index: 1050;" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
<!--    <div class="modal-dialog" role="document">-->
    <div class="modal-dialog with-border" style="width:800px;">
        <div class="modal-content">
            <form id="form_garante" action="controlador.php" method="post">
            <div style="background: #3C8DBC;"  class="modal-header modal-warning">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
                <h4 class="modal-title">Formulario Garante</h4>
            </div>
            ...
            <input  value="guardar_garante" type="hidden" name="action_js" id="action_js">
            </form>
            <div class="modal-footer">
                <button type="button" onclick="guardar_garante()" class="btn btn-primary">Guardar Garante</button>

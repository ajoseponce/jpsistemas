...
//$pass = md5($pass);
	...
	$SQL = "SELECT COUNT(*) AS C FROM cgeconsu_bdcge.usuarios WHERE nombre='".mysql_real_escape_string($user)."' AND clave='".mysql_real_escape_string($pass)."' AND estado='A'";
	echo $SQL;
        //exit;
...
function getPersonas($descrip){
	...
	$SQL="SELECT * FROM  cgeconsu_bdcge.personas WHERE CONCAT(nombre,' ',apellido) LIKE '%".$descrip."%'";
        //echo $SQL;
...
function getPersonasUsuarios($descrip){
	...
	$SQL="SELECT p.*, u.id_usuario FROM  cgeconsu_bdcge.personas p "
...
function getAreas($descrip){
	global $conn;
	 ...
	 $SQL="SELECT * FROM  cgeconsu_bdcge.areas WHERE descripcion LIKE '%".$descrip."%'";
        //echo $SQL;
...
function getTipoEquipo($descrip){
	global $conn;
	 ...
	 $SQL="SELECT * FROM  cgeconsu_bdcge.tipo_equipo WHERE descripcion LIKE '%".$descrip."%'";
        //echo $SQL;
...
function getLugares($descrip){
	global $conn;
	 ...
	 $SQL="SELECT * FROM  cgeconsu_bdcge.lugar WHERE descripcion LIKE '%".$descrip."%'";
        //echo $SQL;
...
function getProveedores($descrip){
	global $conn;
	 ...
	 $SQL="SELECT * FROM  cgeconsu_bdcge.proveedor WHERE descripcion LIKE '%".$descrip."%'";
        //echo $SQL;
...
function getMarcas($descrip){
	global $conn;
	 ...
	 $SQL="SELECT * FROM  cgeconsu_bdcge.marcas WHERE descripcion LIKE '%".$descrip."%'";
        //echo $SQL;
...
function getAplicaciones($descrip){
	global $conn;
	 ...
	 $SQL="SELECT * FROM  cgeconsu_bdcge.aplicativos WHERE nombre_menu LIKE '%".$descrip."%'";
        //echo $SQL;
...
function getPoes($descrip){
	...
	$SQL="SELECT pc.* FROM  cgeconsu_bdcge.poe_cabecera pc "
                . " LEFT JOIN cgeconsu_bdcge.examen e ON e.id_poe=pc.id_poe"
...
function getExamenes($descrip){
	global $conn;
	 ...
	 $SQL="SELECT * FROM  cgeconsu_bdcge.examen WHERE descripcion LIKE '%".$descrip."%'";
        //echo $SQL;

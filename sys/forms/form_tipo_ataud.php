            ...
            <div class="box-body">
                <div class="row">
                    <form action="controlador.php" id="form_datos" method="post" enctype="multipart/form-data">
                        ...
                        <?php } ?>
                        <input type="hidden"  name="action" value="<?php echo base64_encode('guardar_tipo_ataud'); ?>" />
                        <input type="hidden" id="id_tipo_ataud" name="id_tipo_ataud" value="<?php echo (isset($result->id_tipo_ataud))?$result->id_tipo_ataud:""; ?>" />
                        <input type="button"  onclick="guardar_datos()" class="btn btn-default" value="Guardar Datos" />
                        <button onclick="volver_listado('<?php echo base64_encode('listar_tipo_ataud'); ?>')" type="reset"  class="btn btn-default">Volver</button>
                    </form>
                    <!-- /.col -->
                    <!-- /.form-group -->
                </div>

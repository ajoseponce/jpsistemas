                    ...
                    <form action="controlador.php" id="form_datos" method="post" enctype="multipart/form-data">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Nombre en Usuario</label>
                                <input class="form-control" id="suggest_usuario" name="suggest_usuario" value="">
...
<script>
    $(function() {
        autocomleteINI_usuario('usuario', 'ajax/suggestUsuario.php');

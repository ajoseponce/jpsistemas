<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Listado de personas Solicitantes
            <small>=</small>
        </h1>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                  <img data-toggle="modal" onclick="abrir_pop_solicitantes()" style="cursor: pointer;" src="img/agrega_persona.png"/>
                ...
                <div class="panel-body">
                    ...
                    <tr>
                        <th>Apellido
                            <input type="text" size="60" onchange="busca_persona_solicitante()" value="" id="apellido_filtro"  name="apellido_filtro" type="text">
                        </th>
                        <th>Nombre
                            <input type="text" size="60" onchange="busca_persona_solicitante()" value="" id="nombre_filtro"  name="nombre_filtro" type="text">
                        </th>
                    </tr>
                    <tr>
                        <th>DNI
                            <input type="text"  value="" id="dni_filtro"  onchange="busca_persona_solicitante()" name="dni_filtro" type="text">
                        </th>
                        <th>&nbsp;
                        </th>
                    </tr>

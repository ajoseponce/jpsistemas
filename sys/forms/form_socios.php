    ...
    <section class="content">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title">Persona socio</h3>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <input  value="guardar_socio" type="hidden" name="action_js" id="action_js">
                    <input type="hidden" id="id_socio" name="id_socio" value="<?php echo (isset($result->id_socio))?$result->id_socio:""; ?>" />
                    </form>
                    <input type="hidden"  name="action" value="<?php echo base64_encode('guardar_socio'); ?>" />
                        
                        <input type="button"  onclick="guardar_datos()" class="btn btn-default" id="boton_guardar" value="Guardar Datos" />
                        <button onclick="volver_listado('<?php echo base64_encode('listar_socios'); ?>')" type="reset"  class="btn btn-default">Volver</button>
                    <!-- <div class="modal-footer">
                        <button type="button" onclick="guardar_socio()" class="btn btn-primary">Guardar socio</button>
